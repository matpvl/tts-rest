...
urlpatterns = [
    ...
    path(
        "<int:ticket_id>/comment/<int:comment_id>/edit/",
        views.edit_comment,
        name="edit_comment",
    ),
    path(
        "<int:ticket_id>/comment/<int:comment_id>/delete/",
    ...
    path(
        "<int:ticket_id>/comment/<int:comment_id>/upvote/",
        views.upvote_comment,
        name="upvote_comment",
    ),
    path(
        "<int:ticket_id>/comment/<int:comment_id>/downvote/",
    ...
    path(
        "api/v1/add_comment/<int:ticket_id>/",
        views.api_add_comment,
        name="api_ticket_add_comment",
    ),
]
